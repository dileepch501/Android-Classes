...
public class SencondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView = findViewById(R.id.autocompleteview1);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SencondActivity.this, autoCompleteTextView.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        ArrayAdapter autoAdpater=new ArrayAdapter(SencondActivity.this,R.layout.spinner_list_item,getResources().getStringArray(R.array.autolist));

        autoCompleteTextView.setAdapter(autoAdpater);
